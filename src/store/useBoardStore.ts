...
const initialCourts: Court[] = [
    {
        ...
        players: [
            ...
            { id: 'p3', name: '로운', tier: 'A', matchCount: 0 },
            { id: 'p4', name: '이도현', tier: 'B', matchCount: 0 },
        ],
        status: 'waiting',
    },
...
const initialWaitingList: Player[] = [
    { id: 'w1', name: '남주혁', tier: 'B', matchCount: 0 },
    { id: 'w2', name: '차은우', tier: 'C', matchCount: 0 },
    { id: 'w3', name: '송강', tier: 'C', matchCount: 0 },
    { id: 'w4', name: '배인혁', tier: 'C', matchCount: 0 },
    { id: 'w5', name: '노윤서', tier: 'D', matchCount: 0 },
    { id: 'w6', name: '최현욱', tier: 'D', matchCount: 0 },
    { id: 'w7', name: '김영대', tier: 'D', matchCount: 0 },
    { id: 'w8', name: '이재욱', tier: 'D', matchCount: 0 },
    { id: 'w9', name: '김지원', tier: 'E', matchCount: 0 },
    { id: 'w10', name: '한소희', tier: 'E', matchCount: 0 },
    { id: 'w11', name: '고윤정', tier: 'E', matchCount: 0 },
    { id: 'w12', name: '김유정', tier: 'E', matchCount: 0 },
    { id: 'w13', name: '조이현', tier: 'E', matchCount: 0 },
    { id: 'w14', name: '박은빈', tier: 'E', matchCount: 0 },
    { id: 'w15', name: '문가영', tier: 'E', matchCount: 0 },
    { id: 'w16', name: '안효섭', tier: 'E', matchCount: 0 },
    { id: 'w17', name: '서강준', tier: 'E', matchCount: 0 },
    { id: 'w18', name: '남윤수', tier: 'E', matchCount: 0 },
    { id: 'w19', name: '전배수', tier: 'E', matchCount: 0 },
    { id: 'w20', name: '김선호', tier: 'E', matchCount: 0 },
];
