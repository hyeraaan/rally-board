...
const translations = {
    ko: {
        ...
        addPlayerTip: '"a 카리나, b 차은우" 처럼 입력하면 한 번에 추가 가능!',
        addPlayerTitle: '선수 추가',
        bulkAddPlaceholder: '예: a 카리나, b 차은우',
    ...
    en: {
        ...
        addPlayerTip: '"A Karina, B Eunwoo" format adds multiple players!',
        addPlayerTitle: 'Add Player',
        bulkAddPlaceholder: 'e.g. A Karina, B Eunwoo',
